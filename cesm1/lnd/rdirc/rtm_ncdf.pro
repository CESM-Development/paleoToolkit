...
; rtmfile1='rdirc.1x1.myCase'
; outfile='rdirc.1x1.myCase.nc'
; resnum=2		; one degree

rtmfile1='rdirc.0.5x0.5.myCase'
outfile='rdirc.0.5x0.5.myCase.nc'
...
;--  Setup variable attributes  --------------------------
 ...
 NCDF_ATTPUT, id, /GLOBAL, 'history', 'created by xxx 2010-11-01'
 NCDF_ATTPUT, id, /GLOBAL, 'source', 'rdirc.slope.05.100309.txt'
