...
! Determine input and output file names
  ...
  filei_lsmveg =  'veg.2x2deg_per.nc'
  filei_topo   =  'topo.2x2deg_per.nc'
  filei_org    =  'mksrf_zon_organic.10level.nc'
  filei_soitex =  '/glade/p/cesm/cseg/inputdata/lnd/clm2/rawdata/mksrf_soitex.10level.c010119.nc'

  fileo_glacier= 'mksrf_glacier_per.c131029.nc'
  fileo_urban  = 'mksrf_urban_per.c131029.nc' 
  fileo_lanwat = 'mksrf_lanwat_per.c131029.nc'
  fileo_lai    = 'mksrf_lai_per.c131029.nc'
  fileo_pft    = 'mksrf_landuse_per.c131029.nc'
  fileo_soicol = 'mksrf_soicol_per.c131029.nc'
  fileo_soitex = 'mksrf_soitex_per.c131029.nc'
  fileo_organic= 'mksrf_organic_per.c131029.nc'
  fileo_fmax   = 'mksrf_fmax_per.c131029.nc'
  fileo_topo   = 'mksrf_topo_per.c131029.nc'
  fileo_vocef  = 'mksrf_vocef_per.c131029.nc'
...
! -----------------------------------------------------------------------
  ...
  do j = 1,nlon
  do i = 1,nlat
   if(landmask(j,i) == 1.) soil_color(j,i) = 20._r8   ! nanr: mksurfdata_map hardcoded for 8 or 20 
