...
set INPUT_LSM_DATA = veg.2x2deg.nc
set INPUT_TOP_DATA = topo.2x2deg.nc

# Soil texture (use present day)
set INPUT_SOI_DATA = /glade/p/cesm/cseg/inputdata/lnd/clm2/rawdata/mksrf_soitex.10level.c010119.nc 
...
EOF
cp  paleo_mkraw_cesm1_public_sed.F90 paleo_mkraw_cesm1.F90 
sed -f pathnames.sed paleo_mkraw_cesm1_public_sed.F90 >! paleo_mkraw_cesm1.F90
